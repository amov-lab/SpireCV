...
{
  gimbal->setAngleRateEuler(0, yOffset * 50.0f, 0);
}
...
{
  // // 实例化吊舱
  gimbal = new sv::Gimbal(sv::GimbalType::SU17, sv::GimbalLink::ETHERNET_UDP2);
  ...
  cap.setRtspUrl("rtsp://192.168.1.99:1234/test.sdp");
